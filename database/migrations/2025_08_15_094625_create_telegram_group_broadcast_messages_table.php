...
return new class extends Migration
{
    ...
    {
        Schema::create('telegram_group_broadcast_messages', function (Blueprint $table) {
            $table->id();
            $table->text('message')->comment('消息内容');
            $table->json('target_groups')->nullable()->comment('目标群组 ID 数组');
            ...
            $table->integer('total_groups')->default(0)->comment('目标群组总数');
    ...
    {
        Schema::dropIfExists('telegram_group_broadcast_messages');
    }
};
